            ...
            <Paper withBorder radius="md" shadow="md">
                <Group p={6} gap="xs" >
                    <Tooltip label="Add Rectangle">
                        <ActionIcon variant="transparent" size="lg" onClick={addRectangle}>
                            <Rectangle size={20} />
                        </ActionIcon>
                    </Tooltip>
                    <Tooltip label="Add Oval">
                        <ActionIcon variant="transparent" size="lg" onClick={addOval}>
                            <Circle size={20} />
                        </ActionIcon>
                    </Tooltip>
                    <Divider orientation="vertical" />
                    <Tooltip label="Delete Selected">
                        <ActionIcon variant="transparent" size="lg" disabled={!selectedShapes || selectedShapes.length == 0} onClick={deleteSelected}>
                            <Trash size={20} />
                        </ActionIcon>
                    </Tooltip>
                    <Tooltip label="Delete All">
                        <ActionIcon variant="transparent" size="lg" onClick={deleteAll}>
                            <Eraser size={22} />
                        </ActionIcon>
                    </Tooltip>
                    <Divider orientation="vertical" />
                    <Tooltip label="Undo">
                        <ActionIcon variant="transparent" size="lg" disabled={!canUndo} onClick={undo}>
                            <ArrowCounterClockwise size={20} />
                        </ActionIcon>
                    </Tooltip>
                    <Tooltip label="Redo">
                        <ActionIcon variant="transparent" size="lg" disabled={!canRedo} onClick={redo}>
                            <ArrowClockwise size={20} onClick={redo} />
                        </ActionIcon>
                    </Tooltip>
                </Group>
            </Paper>
